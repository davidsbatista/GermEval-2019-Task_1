...
other methods for the root classifier, namely with:

\begin{itemize}
\item Hierarchical Attention Networks~\cite{yang-etal-2016-hierarchical}
\item Bag-of-Tricks~\cite{joulin-etal-2017-bag}
\item bi-LSTM~\cite{Hochreiter:1997:LSM:1246443.1246450}
\item ConvNets~\cite{kim-2014-convolutional}
\end{itemize}
