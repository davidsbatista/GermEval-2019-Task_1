...
We pre-processed the data by using the german tokenizer available on NLTLK 3.4.1~\cite{Bird:2009:NLP:1717171} and considered only alphanumeric tokens.
...
- norm': ('l1', 'l2'),
- regularization parameter C: [300],
