...
%TODO: only to write the code and have a working framework for experiments
...
%TODO: also 30% for validation split? yes

\end{comment}

%TODO: - coverage of results: 0.5, if nothing 0.4, if nothing 0.3
...
% The Logistic Regression classifier achieved the best results although the CNN
% classifier was had a similar F\textsubscript{1} score, essentially by trading recall for precision.
...
used a CNN again based on the model proposed by~\shortcite{kim-2014-convolutional}.
...
- % no global classifier faltou um post-processing step
