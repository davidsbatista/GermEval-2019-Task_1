...
The dataset contains 3 levels and it's considered a hierarchically multi-label since any example
can be can assigned to more than one class at any given level of the hierarchy. The hierarchy
contains a totalling of 343 classes distinct classes:

\begin{itemize}
% binary classifiers per node, one-vs-all
\item{Level 1: 8 classes}
\item{Level 2: 93 classes}
\item{Level 3: 242 classes}
\end{itemize}

There are XX XXX samples in the training dataset provided by the shared task organizers.
...
and it was first proposed in the seminal work of \cite{Koller:1997:HCD:645526.657130}, it is also
sometimes refered to as top-down approach in the literature.
