...
\begin{abstract}
We present a detailed description of the systems used to generate two submissions
for the GermEva'19 Task 1 on on hierarchical classification of blurbs.

We achieved the 11th place out of 19th submissions for subtask_a and we
...
\section{System Developed}\label{system}
...
subtask_a
- Comtravo-DS	Comtravo-DS__local_clf_logit_cnn	13	0.7178	0.8144	0.8255	0.8199	0.943
- Comtravo-DS__global_clf_cnn	17	0.7183	0.7761	0.7839	0.78	0.9925

subtask_b
- Comtravo-DS__local_clf_logit_cnn	11	0.1924	0.7042	0.5274	0.6031	1	0.943
