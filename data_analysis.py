...
def main():
    # train and test data
    # train_data_x, train_data_y, labels = load_data('blurbs_train_all.txt', dev=True)

    # dev data
    train_data_x, train_data_y, labels = load_data('blurbs_dev_participants.txt', dev=True)
